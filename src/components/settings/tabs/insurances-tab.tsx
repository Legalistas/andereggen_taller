...
export default function InsurancesTab() {
  ...
  const submit = async () => {
    ...
    try {
      const url = editing
        ? `/api/insurance-companies/${editing.id}`
  ...
  const submitDelete = async () => {
    ...
    setDeleteBusy(true);
    try {
      await fetch(`/api/insurance-companies/${deleteTarget.id}`, {
        method: "DELETE",
      });
      ...
      >
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Los datos se usan al cargar vehículos y en notificaciones a la
              aseguradora.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-3 py-2">
            ...
            <div className="flex items-center justify-between gap-2 pt-1">
              <Label htmlFor="insActive" className="cursor-pointer">
                Activa
              </Label>
              <Switch
                id="insActive"
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              {deleteTarget && (
                <>
                  ¿Seguro querés eliminar <b>{deleteTarget.name}</b>? Esta
