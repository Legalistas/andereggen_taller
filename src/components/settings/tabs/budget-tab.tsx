...
export default function BudgetTab({ settings, onSave }: Props) {
  ...
  const submit = async () => {
    ...
    setMsg(
      res.ok
        ? { ok: true, text: "Defaults de presupuesto actualizados." }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="grid gap-1.5">
          ...
          <Input
            ...
            onChange={(e) =>
              setForm((f) => ({ ...f, defaultIvaRate: e.target.value }))
            }
          />
        </div>
        <div className="grid gap-1.5">
          ...
          <Input
            ...
            onChange={(e) =>
              setForm((f) => ({ ...f, defaultValidityDays: e.target.value }))
            }
          />
        </div>
        <div className="grid gap-1.5">
          ...
          <Input
            ...
            onChange={(e) =>
              setForm((f) => ({ ...f, defaultDeliveryDays: e.target.value }))
            }
          />
        </div>
        <div className="grid gap-1.5 md:col-span-2">
          ...
          <Input
            ...
            value={form.defaultPaymentCondition}
            onChange={(e) =>
              setForm((f) => ({
                ...f,
                defaultPaymentCondition: e.target.value,
              }))
            }
          />
        </div>
